...
class NProduto : Model<Produto> 
{
  public List<Produto> ListarPreco(double preco) {
    List<Produto> r = new List<Produto>();
    FromXML();
    foreach(Produto obj in objetos) 
      if (obj.Preco <= preco) r.Add(obj);
    return r;
  }
}

static class NProduto2 {
